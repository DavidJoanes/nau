...
var PTNavBar = {
 ...
 var elBody = document.querySelector('body'); var nbMask = document.querySelector('#psNavBarMask'); var nbIF = document.querySelector('#psNavBarIFrame'); var elmod = document.getElementById('pt_modals'); if (this.IsOpen) {
 ...
 window.top.PTNavBar.StartPersState = PTNavBar.OpenState; PTNavBar.ShowContentArea(); setPSTouchHandlerDraggbles(); var elperstiles = document.querySelectorAll('.nbpers .nbtile-row'); if (elperstiles && elperstiles.length !== 0) {
