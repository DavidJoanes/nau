...
navBarWidgetDiv.setAttribute("role","presentation");var srchElm = top.document.getElementById('pthdr2suggestionsearch');if (srchElm)
 srchElm.setAttribute("title", "Global Search");if(searchLink && actionlistSearch)
{
