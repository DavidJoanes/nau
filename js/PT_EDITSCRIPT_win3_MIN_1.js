...
var oErr_win3 = null;function PSwarning_win3(msg)
{
msg = PSmessageSubst_win3(msg, PSwarning_win3.arguments, 1);if (isFModeLayout()) 
 psConfirmFluid("Warning", msg, "", "", "", "");else
 psAlert(msg, "Warning");}

function PSdeferWarning_win3(msg)
{
sDefMsg_win3 = PSmessageSubst_win3(msg, PSdeferWarning_win3.arguments, 1);bDefWarning_win3 = true;}

function PSerror_win3(obj, msg)
{
if (bReset_win3)
{
 resetChange(obj); bReset_win3 = false;}
else
{
 obj.PSsaveclass = obj.className; obj.className = "PSERROR";}
msg = PSmessageSubst_win3(msg, PSerror_win3.arguments, 2);if (isFModeLayout()) 
 psConfirmFluid("Error", msg, "", "", "", "");else
 psAlert(msg, "Error");oErr_win3=obj;}

function PSdeferError_win3(obj, msg)
{
sDefMsg_win3 = PSmessageSubst_win3(msg, PSdeferError_win3.arguments, 2);oDefErr_win3=obj;bDefWarning_win3 = false; }

function PSshowDeferredMsg_win3()
{
if (sDefMsg_win3=="")return;if (bDefWarning_win3)
 PSwarning_win3(sDefMsg_win3);else
 PSerror_win3(oDefErr_win3, sDefMsg_win3);sDefMsg_win3 = "";oDefErr_win3 = null; }

function PSclearError_win3(obj)
{
if (obj == oDefErr_win3)
{
 sDefMsg_win3 = "";  oDefErr_win3 = null; }
}

function PSmessageSubst_win3(msg, parms, startparm)
{
...
function FindString_win3(obj)
{
var s = prompt("Enter search string:","");if (s == null || s == "")
 return false;obj.value = s;return true;}

function DeleteCheck_win3(form,name)
{


var deleteAction = 'oParentWin.aAction_win3(oParentWin.document.win3' + ',"' + name + '")';if (typeof CKEDITOR != 'undefined') UpdateEditorLinkedField();psConfirm2("Delete Confirmation", "Delete current/selected rows from this page?  The delete will occur when the transaction is saved.", "OKCancel", " ", deleteAction);}

function DeleteCheck2_win3(name)
{
gFocusObj = document.getElementById(name);if (arguments.length == 0) 
 return confirm("Delete current/selected rows from this page?  The delete will occur when the transaction is saved.");else if(arguments.length ==1 && (typeof event != 'undefined') && event.altKey && bAccessibility_win3 && !isFModeLayout())
 return confirm("Delete current/selected rows from this page?  The delete will occur when the transaction is saved.");else 
 {
 if (bAccessibility_win3 && !PT_isModalDialogPresent()) 
 var deleteAction = 'submitAction_win3(document.win3' + ',"' + arguments[0] + '")'; else 
 var deleteAction = 'oParentWin.aAction_win3(oParentWin.document.win3' + ',"' + arguments[0] + '")';     if (isFModeLayout())
...
var oChange_win3 = null;var oDefErr_win3 = null;var sDefMsg_win3 = "";var bDefWarn_win3; var oKillFocus_win3 = null;var oTargetFocus_win3 = null;var bReset_win3 = false;function initVars_win3()
{


oChange_win3 = null;oDefErr_win3 = null;sDefMsg_win3 = "";bDefWarn_win3 = false; oKillFocus_win3 = null;oTargetFocus_win3 = null;bReset_win3 = false;nLastKey_win3 = 0;}
function moveFocus_win3(killobj)
{
if (typeof popupObj_win3 != "undefined" && popupObj_win3 && popupObj_win3.isShown) 
 ptCommonObj2.tryFocus0(popupObj_win3.popupFocus);if (oErr_win3!=null)
{
 oKillFocus_win3 = killobj; oTargetFocus_win3 = oErr_win3; oErr_win3.focus(); oErr_win3 = null;}
}

function doFocus_win3(obj,bTabonly,bDef)
{
if (obj == null) return;if (isFModeLayout() && oChange_win3 != obj && (obj.type == "checkbox" || obj.type == "radio")) 
{
 var sScript = obj.getAttribute('onclick'); if (sScript && (sScript.indexOf("submitAction_") != -1) && (getLastKey_win3() != "\t".charCodeAt(0))) { 
 oChange_win3 = null; return; }
}


if (typeof gridRowSelRgbColor_win3 != "undefined") {
 var gridRowID = getGridRowID(obj);  if (gridRowID != null && gridRowID.length > 0 )
 HighLightTR(gridRowSelRgbColor_win3,'',gridRowID);}
...
if (window.focusHook)
 focusHook(obj);if (obj==oTargetFocus_win3)
{
 oTargetFocus_win3 = null; oKillFocus_win3 = null; return;}


if (typeof dateBoxOpen != "undefined" && dateBoxOpen && obj.id.indexOf("$prompt") == -1)
 closeCal2(obj);var nRCFLastKey = getLastKey_win3();if(!bTabonly || nRCFLastKey == "\t".charCodeAt(0))
{
 if(oChange_win3!=null && oChange_win3!=obj)
 {
 if (oChange_win3.form){
 oChange_win3.form.ICFocus.value=obj.id; oChange_win3.form.ICFocus.nRCFLastKey = nRCFLastKey; submitAction_win3(oChange_win3.form,oChange_win3.id); }
 else{
 if (document.getElementById(oChange_win3.id) && document.getElementById(oChange_win3.id).form ){
 document.getElementById(oChange_win3.id).form.ICFocus.value = obj.id; document.getElementById(oChange_win3.id).form.ICFocus.nRCFLastKey = nRCFLastKey; submitAction_win3(document.getElementById(oChange_win3.id).form,oChange_win3.id); }
 }
 oChange_win3 = null; }
 else if(bDef && oDefErr_win3!=null && oDefErr_win3!=obj)
 PSshowDeferredMsg_win3();}
moveFocus_win3(obj);}

function doFocusMac_win3(obj,bTabonly)
{
if (obj==oTargetFocus_win3)
{
 oTartgetFocus_win3 = null; oKillFocus_win3 = null; return;}


if (typeof dateBoxOpen != "undefined" && dateBoxOpen)
 closeCal2();document.win3.ICFocus.value = obj.id;if(oDefErr_win3!=null && oDefErr_win3!=obj)
 PSshowDeferredMsg_win3();moveFocus_win3(obj);}

function doReqField_win3(obj, bserver, bnumeric)
{

if (oKillFocus_win3==obj)
...
{
 if (bserver)
 oChange_win3=obj; else
 PSdeferError(obj, "Field is required."); }
}

function addchg_win3(obj,id) {
...
if (isFModeLayout() && obj.type == "select-one")
 ...
 if (typeof document.chgFldArr_win3 != "undefined" && document.chgFldArr_win3 != "undefined")
 {
 var bFound = false; for (var i = 0; i < document.chgFldArr_win3.length; i++) {
 if (document.chgFldArr_win3[i] == id) {
 bFound = true; continue; }
 }
 if (!bFound) 
 document.chgFldArr_win3.push(id); }
 } catch (e) {}
}

function doEdits_win3(obj,sType,bHist,bEffdtSub,bDate,bYN,bUCase,bImmed, re)
{

gFocusObj=obj;if(sDefMsg_win3!="")
{
 PSshowDeferredMsg_win3(); return false;}


if(oChange_win3 != null)
{
 submitAction_win3(obj.form,obj.id); return true;}
...
var bErr = false; if(sType!='') bErr = checkType_win3(obj, sType, re);if(!bErr && bHist=='Y') bErr = historyUpdated_win3(obj);if(!bErr && bEffdtSub=='Y') bErr =subscrollUpdated_win3(obj);if(!bErr && bDate=='Y') bErr = isReasonableDate_win3(obj);if(!bErr && bYN=='Y') bErr = isYN_win3(obj);if (bErr && bImmed=='Y') PSshowDeferredMsg_win3();return true;}
...
function historyUpdated_win3(obj)
{
if (!isChanged(obj))
 return false;PSdeferError_win3(obj, "Cannot change current or history records unless in Correction mode.");bReset_win3 = true;return true;}

function subscrollUpdated_win3(obj)
{
if (!isChanged(obj))
 return false;PSdeferError_win3(obj, "Cannot change key field with effective dated subordinate data unless in Correction mode.");bReset_win3 = true;return true;}



function isReasonableDate_win3(obj)
{
if(obj.type == "select-one") obj = obj.options[obj.selectedIndex];var dateval = new Date(obj.value);var now = new Date();var diff = new Date(Math.abs(now.getTime() - dateval.getTime()));if (diff.getMonth > 0)
 ...
 PSdeferWarning_win3("Warning -- date out of range.");return false;}


function isYN_win3(obj)
{
 ...
 val = obj.value;if (val != 'Y' && val != 'N')
{
 ...
 PSdeferError_win3(obj, "Value must either be Y for Yes or N for No."); return true;}
return false;}


function isNumOnly_win3(obj)
{
var val = obj.value;if (val == '') return false;if (val.search(/^ *\d* *$/) != 0)
{
 
 PSdeferError_win3(obj, "Numeric Only field format error.  Please reenter."); return true;}
return false;}

function isNumeric_win3(obj,fmt,re)
{
var val = obj.value;if (val == '') return false;if (val.search(re) != 0)
{
 
 PSdeferError_win3(obj, "Number field format error. This field accepts %1 number. %2", fmt); return true;}
return false;}

function isTime_win3(obj,fmt)
{
var val = obj.value;if (val == '') return false;if (!checkTime(val,fmt))
{
 
 PSdeferError_win3(obj, "Time field format error.  Please re-enter using the proper format."); return true;}
return false;}

function isDateTime_win3(obj,fmt)
{
var val = obj.value;if (val == '') return false;var newval = checkDateTime(val,fmt);if (newval == "")
{
 
 PSdeferError_win3(obj, "Datetime field format error.  Please reenter using the proper format."); return true;}
obj.value = newval;return false;}

function isDate_win3(obj,fmt)
{
var val = obj.value;if (val == '') return false;var dt = getDate(val,fmt,szCalendarType);if (dt==null)
{
 PSdeferError_win3(obj, "The system does not understand the date you entered.");  return true;}
obj.value = pt_formatDate(dt, fmt, szCalendarType);return false;}

function checkType_win3(obj,sType,re)
{
var cType = sType.substring(0, 1);var sFmt = sType.substring(1);switch(cType)
{
case 'N': return isNumOnly_win3(obj);case 'S': return isNumeric_win3(obj,sFmt,re);case 'D': return isDate_win3(obj,sFmt);case 'T': return isTime_win3(obj,sFmt);case 'X': return isDateTime_win3(obj,sFmt);}
return false;}
...
function setSelectElemOptions_win3()
{

var bIE = (navigator.userAgent.toLowerCase().indexOf('msie') || navigator.userAgent.toLowerCase().indexOf('trident'));if (typeof selectElemOptions_win3 != "undefined")
 {
 for (var i = 0; i < selectElemOptions_win3.length; i++)
 {
 var selectElem = document.forms['win3'].elements[selectElemOptions_win3[i][0]]; if (selectElem == null)
 continue; if (selectElem.options != null)
 var curLen = selectElem.options.length; else
 var curLen = 0; var options = optionsArray_win3[selectElemOptions_win3[i][1]];     var selected = selectElemOptions_win3[i][2]; var erroraccess = selectElemOptions_win3[i][3]; if (typeof options == "undefined" || options==null || selected == null)
