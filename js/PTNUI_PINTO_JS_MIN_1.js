...
var PTPinTo = {
 ...
 curLP = "<a class='disabled' aria-disabled='true'>" + rcd[i].label + " (already added)</a>"; } else {
 ...
 var lblPin = encodeURIComponent(lblPinObj.value).replace(/'/g, "%27"); url = url.replace(/(crefLabel=)[^\&]+/, 'crefLabel=' + lblPin); } else {
