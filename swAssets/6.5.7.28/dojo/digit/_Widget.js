...
if(has("dijit-legacy-requires")){ready(0,function(){var requires=["dijit/_base"];
require(requires)
})
}return _Widget
});
//# sourceURL=/swAssets/6.5.7.28/dojo/dijit/_Widget.js