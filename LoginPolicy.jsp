...
<table id="LoginTable" border="0" cellspacing="0">
    ...
    <tr id="BackgroundDisplayHelper">
        ...
        <script type="text/javascript">
            ...
            <form id="loginForm" name="loginForm" method="post" action="/WebNetworkAuth/">
                <input type="hidden" name="csrfToken" value="hMkXJsapYlMUJPXth6kx"/>
    ...
    <tr id="loginFooterRow">
        ...
        <img src="/swDashboard/images/icons/stock/iToolbar 2/16x16/exclamation.png" title="ext-relay-CYAPWKS04" style="float:left">
