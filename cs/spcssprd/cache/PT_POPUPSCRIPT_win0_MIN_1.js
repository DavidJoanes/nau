...
HidePopup:function() 
{
 ...
 var popupFrame = document.getElementById(this.MOPopFrame);  var hPop = document.getElementById(this.hoverpopupId);  if(hPop)
 hPop.innerHTML = popupFrame.innerHTML; popupFrame.innerHTML = null; var nLen = document.forms.length; for (var i=0; i<nLen; i++)
 {
...
ShowPopup:function(evt,winname) 
{
 ...
 this.focusElem=null; HelppopupObj_win0.SetHeader(winname); HelppopupObj_win0.SetShadow(winname); var HelppopContainer = document.getElementById("HelppopupContainer_"+winname); var HelppopFrame = document.getElementById("HelpdivpopupFrame_"+winname); document.getElementById("#HELPPOPUPCLOSE").focus(); ptEvent.add(HelppopContainer,"keypress",function(evt){HelppopupObj_win0.HandleEscapeKey(evt,winname)}); cancelBubble(evt);},
