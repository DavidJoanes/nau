...
var gFocusObj = null;var bRichTextEnabled = 0;var gRichTextField = null;var bTimer=null;var objBeforeOrAfterFocusSave = null; var objToBeFocus = null; var gcurSearchRowId = "";var gActiveBtn = null;var gSetFocusByAjax = false; var inside_win0 = false;var called_win0= false;var gCalendarClose = false;callbackOnDelay_win0= function() {
   ...
   window.doKeyPress_win0 = function (evt)
    ...
    return false;  if (target && typeof target.form == "undefined")
    return false; }
   ...
   function MoveImgUrlToCkeditorInstance(fldId)
   {
    ...
    const image = writer.createElement( 'image', { src: imgurl } ); editorInstance.model.insertContent( image , editorInstance.model.document.selection); } );}
   ...
   {
    top.Ckeditor5CurrFieldIdForImgUpload = fldId ; if(top.bFMode === true)
    var url = "c/PTRTE.PTUPLOAD_CKE5FLUID.GBL?URLID=PT_RTE_IMG_DB_LOC&TYPE=record://PTRTDB" ; else
    var url = "c/PTRTE.PTUPLOAD_CKE5.GBL?URLID=PT_RTE_IMG_DB_LOC&TYPE=record://PTRTDB" ; var options = ""; url = generateNewwinURL_CKE5() + url; url = url.replace("/psp/", "/psc/"); if(top.bFMode === true)
    processing_win0(1,3000); else
    setTimeout(function(){ ptCommonObj2.showPopupMask(MTop()) }, 4000); doModeless(url, options);}
