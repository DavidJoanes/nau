...
function DestroyCke5Fields()
{
 ...
 var l = "ckeditor5Script(".length ; var fldId = cke5editorlist[e].innerText.substring(l + 1, cke5editorlist[e].innerText.length - 3); var tmp = document.getElementById(fldId); var tmp_scripttag = document.getElementById(fldId + "_SCRIPT"); if(tmp !== null)
 tmp.dispatchEvent(cke5EestroyEvent); if(tmp_scripttag !== null)
 tmp_scripttag.remove(); }
 } 
}
...
function PTRTEFillcacheCke5(URI,UrlID,UrlRepository,EditorField,DisplayOnly)
{
 ...
 {
 var img = images[i]; if(images[i].id.includes("###"))
 { 
 ...
 {
 var updatedRteValue = rtetextareaValue.replace(new RegExp(srcValueToUpdate, 'g'), srcValueToUpdate+"###"+fileName); EditorStringObj.value = ""+updatedRteValue; }
 }
 else 
 {
